...
${OBJECTDIR}/RTIMULib/RTFusion.o: RTIMULib/RTFusion.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RTIMULib/RTFusion.o RTIMULib/RTFusion.cpp

${OBJECTDIR}/RTIMULib/RTFusionKalman4.o: RTIMULib/RTFusionKalman4.cpp 
	${MKDIR} -p ${OBJECTDIR}/RTIMULib
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RTIMULib/RTFusionKalman4.o RTIMULib/RTFusionKalman4.cpp

${OBJECTDIR}/RTIMULib/RTFusionRTQF.o: RTIMULib/RTFusionRTQF.cpp 
	${MKDIR} -p ${OBJECTDIR}/RTIMULib
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RTIMULib/RTFusionRTQF.o RTIMULib/RTFusionRTQF.cpp

${OBJECTDIR}/RTIMULib/RTIMUAccelCal.o: RTIMULib/RTIMUAccelCal.cpp 
	${MKDIR} -p ${OBJECTDIR}/RTIMULib
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RTIMULib/RTIMUAccelCal.o RTIMULib/RTIMUAccelCal.cpp

${OBJECTDIR}/RTIMULib/RTIMUHal.o: RTIMULib/RTIMUHal.cpp 
	${MKDIR} -p ${OBJECTDIR}/RTIMULib
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RTIMULib/RTIMUHal.o RTIMULib/RTIMUHal.cpp

${OBJECTDIR}/RTIMULib/RTIMUMagCal.o: RTIMULib/RTIMUMagCal.cpp 
	${MKDIR} -p ${OBJECTDIR}/RTIMULib
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RTIMULib/RTIMUMagCal.o RTIMULib/RTIMUMagCal.cpp

${OBJECTDIR}/RTIMULib/RTIMUSettings.o: RTIMULib/RTIMUSettings.cpp 
	${MKDIR} -p ${OBJECTDIR}/RTIMULib
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RTIMULib/RTIMUSettings.o RTIMULib/RTIMUSettings.cpp

${OBJECTDIR}/RTIMULib/RTMath.o: RTIMULib/RTMath.cpp 
	${MKDIR} -p ${OBJECTDIR}/RTIMULib
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RTIMULib/RTMath.o RTIMULib/RTMath.cpp

${OBJECTDIR}/RTIMULibDrive.o: RTIMULibDrive.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RTIMULibDrive.o RTIMULibDrive.cpp
